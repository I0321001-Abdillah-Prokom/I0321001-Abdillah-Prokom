...
if kendaraan == "city car" :
    ...
    if pertanyaan == "1" :
        print ("Cicilan yang harus dibayarkan adalah = Rp", cicilanCityCar1)
    elif pertanyaan == "2" :
        print ("Cicilan yang harus dibayarkan adalah = Rp", cicilanCityCar2)
    elif pertanyaan == "3" :
        print ("Cicilan yang harus dibayarkan adalah = Rp", cicilanCityCar3)
    elif pertanyaan == "4" :
        print ("Cicilan yang harus dibayarkan adalah = Rp", cicilanCityCar4)
    elif pertanyaan == "5" :
        print ("Cicilan yang harus dibayarkan adalah = Rp", cicilanCityCar5)
    else :
